...
class PathUtil:
    ...
    @staticmethod
    def get_bugs_filepath(filename='bugs'):
        return Path(DATA_DIR, f"{filename}.json")

    @staticmethod
    def get_filtered_bugs_filepath(filename="filtered_bugs"):
        return Path(DATA_DIR, f"{filename}.json")
    ...
    @staticmethod
    def get_bug_kg_filepath():
        return Path(DATA_DIR, "bugs_with_step_object.json")
    ...
    @staticmethod
    def get_scenarios_filepath(filename="scenarios"):
        return Path(DATA_DIR, f"{filename}.json")
